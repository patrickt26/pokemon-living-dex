...
export function SpecialFormsPage(){
  ...
  const groupKeys:Partial<Record<string,{name:TranslationKey;description:TranslationKey}>>={unown:{name:'variantUnownName',description:'variantUnownDescription'},rotom:{name:'variantRotomName',description:'variantRotomDescription'},furfrou:{name:'variantFurfrouName',description:'variantFurfrouDescription'},'flabebe-line':{name:'variantFlabebeName',description:'variantFlabebeDescription'}};

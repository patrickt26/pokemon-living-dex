...
const swshIds = uniqueSpeciesIds(generatedGameDexes.galar, generatedGameDexes.isleOfArmor, generatedGameDexes.crownTundra, dynamaxAdventureNumbers);
...
export const games: Game[] = [
  ...
  {id:'pla',name:'Pokémon Legends: Arceus',shortName:'PLA',color:'#376d69',logo:'/game-logos/pla.png',dexSpeciesIds:toSpeciesIds(generatedGameDexes.hisui),dexSections:[{id:'hisui',name:'Hisui Dex',dexSpeciesIds:toSpeciesIds(generatedGameDexes.hisui),formOverrides:hisuiFormOverrides}]},
  ...
  {id:'za',name:'Pokémon Legends: Z-A',shortName:'Z-A',color:'#58a57b',logo:'/game-logos/za.png',dexSpeciesIds:zaIds,dexSections:[{id:'lumiose',name:'Lumiose Dex',dexSpeciesIds:toSpeciesIds(generatedGameDexes.lumiose)},{id:'hyperspace',name:'Mega Dimension · Hyperspace Dex',dexSpeciesIds:toSpeciesIds(generatedGameDexes.hyperspace)}]}
];

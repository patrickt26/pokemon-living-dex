...
export interface Game { id: GameId; name: string; shortName: string; color: string; logo?: string; dexSpeciesIds: SpeciesId[]; dexSections?: GameDexSection[]; hasDex?: boolean; }
...
export interface CollectionEntry { id: string; speciesId: SpeciesId; formId: FormId; shiny: boolean; gameId: GameId; ownOT: boolean; quantity: number; originGameId?: GameId; createdAt: string; updatedAt: string; }
export type CollectionEntryInput = Omit<CollectionEntry, 'id' | 'createdAt' | 'updatedAt'>;

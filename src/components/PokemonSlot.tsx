...
interface Props { species: Species; form: PokemonForm; owned: boolean; quantity: number; alpha?: boolean; dexNumber?: number; onClick: () => void; onQuickAdd?: () => void }
export const PokemonSlot = memo(function PokemonSlot({ species, form, owned, quantity, alpha=false, dexNumber = species.nationalDexNumber, onClick, onQuickAdd }: Props) {
